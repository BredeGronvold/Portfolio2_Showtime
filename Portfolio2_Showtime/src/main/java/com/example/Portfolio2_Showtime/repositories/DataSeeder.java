...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedItems(){
        ...
        List<Item> items = asList(new Item("Volleyball", 350, "https://freepngimg.com/thumb/volleyball/28621-8-volleyball-free-download-thumb.png", "Description"),
                new Item("Football", 400, "https://www.premierleague.com/resources/prod/e1fd15c-3351/i/nike-ball-hub/index/21.png", "Description"),
                ...
                new Item("Tennis ball", 5, "https://assets.stickpng.com/images/580b585b2edbce24c47b2b90.png", "Description"),
                new Item("American football", 450, "https://www.pngkey.com/png/full/166-1664900_american-football-transparent-background-png-american-football-ball.png", "Description")
        );
